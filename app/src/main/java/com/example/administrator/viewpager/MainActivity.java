...
import com.example.administrator.viewpager.MyFragmentAdapter;
...
private long startTime = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView(); initLineImage(); }
    /** * 重新设定line的宽度 */
    private void initLineImage() {
        // TODO Auto-generated method stub /** * 获取屏幕的宽度 */
        DisplayMetrics dm = new DisplayMetrics();
        getWindowManager().getDefaultDisplay().getMetrics(dm);
        int screenW = dm.widthPixels; /** * 重新设置下划线的宽度 */
        LayoutParams lp = line_tab.getLayoutParams(); lp.width = screenW / 3;
